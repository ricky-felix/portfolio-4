      ...
      <div className="container">
        <div className="max-w-3xl">
          ...
          <p className="font-body text-lg text-muted-foreground mb-12 max-w-xl">
            I'm currently accepting new projects. If you have an idea 
            you'd like to bring to life, I'd love to hear from you.
          </p>
          ...
          >
            <span className="link-underline">hello@studio.com</span>
            <svg 
